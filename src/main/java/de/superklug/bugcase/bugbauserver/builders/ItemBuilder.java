...
public class ItemBuilder {
    ...
    public ItemBuilder(BugBauserver plugin, final Material type, final int amount, final short damage) {
        this.plugin = plugin;
    ...
    public ItemBuilder setSkullTexture(final String texture) {
        try {
            ...
            GameProfile profile = (GameProfile) plugin.getReflectionUtil().get(itemMeta, "profile");
            ...
            plugin.getReflectionUtil().set(itemMeta, "profile", profile);
